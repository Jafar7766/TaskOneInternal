...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        files.setOnClickListener(view -> {saveInternalFiles("FILES");});
        cache.setOnClickListener(view -> {saveInternalFile("CACHE");});
        delete.setOnClickListener(view -> {deleteInternalFile();});
    }
